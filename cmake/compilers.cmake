...
function(CHECK_COMPILERS)
    ...
    if(CMAKE_CXX_COMPILER_ID STREQUAL "Clang")
        ...
        set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -stdlib=libc++" CACHE STRING "Linker flags for clang" FORCE)
        set(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} -stdlib=libc++" CACHE STRING "Shared linker flags for clang" FORCE)
