...
public:
    ...
    // ARC APB BAR0 base + NOC0 NIU offset + node ID register offset = 0x1FF5002C.
    uint32_t get_read_checking_offset() const override {
        return wormhole::ARC_APB_BAR0_XBAR_OFFSET_START + 0x50000 + wormhole::NOC_NODE_ID_OFFSET;
    }
