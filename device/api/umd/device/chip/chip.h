...
public:
    ...
    virtual void set_tensix_risc_reset(tt_xy_pair core, const TensixSoftResetOptions& soft_resets);
    virtual void unset_tensix_risc_reset(tt_xy_pair core, const TensixSoftResetOptions& soft_resets);
