...
/**
 * SystemMemoryBuffer class should represent the resource of the HOST memory that is visible to the device.
...
private:
    ...
    // Offsets in other SystemMemoryBuffer functions are not allowed to be larger than this size.
    size_t buffer_size_;
