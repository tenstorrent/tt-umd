...
struct Window {
     ...
     *
     * The hardware field is six bits wide, so a programmed window carries 0..63 here and every
     * shift below stays defined. A wider value does not describe any window the ATT can hold.
     */
    uint8_t mask_bits;
