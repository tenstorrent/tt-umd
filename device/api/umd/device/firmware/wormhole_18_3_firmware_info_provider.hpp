...
public:
    ...
    std::optional<SemVer> get_eth_fw_version_semver() const override;

    std::optional<SemVer> get_gddr_fw_version() const override;

    std::optional<SemVer> get_cm_fw_version() const override;

    std::optional<SemVer> get_dm_app_fw_version() const override;

    std::optional<SemVer> get_dm_bl_fw_version() const override;

    std::optional<SemVer> get_tt_flash_version() const override;
    ...
    std::optional<std::vector<bool>> get_eth_heartbeat_status() const override;
