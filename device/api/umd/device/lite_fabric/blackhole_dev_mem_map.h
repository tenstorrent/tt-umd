...
#define MEM_TENSIX_FABRIC_LITE_BARRIER 48
...
#define MEM_IERISC_FABRIC_LITE_BARRIER (MEM_ERISC_RESERVED1 + MEM_ERISC_RESERVED1_SIZE)
#define MEM_IERISC_MAILBOX_BASE (MEM_IERISC_FABRIC_LITE_BARRIER + 16)
...
#define MEM_AERISC_FABRIC_LITE_BARRIER (MEM_ERISC_RESERVED1 + MEM_ERISC_RESERVED1_SIZE)
#define MEM_AERISC_MAILBOX_BASE (MEM_AERISC_FABRIC_LITE_BARRIER + 16)
...
/////////////
// Lite Fabric memory map. This runs on ERISC1 and without metal firmware
//
#define MEM_LITE_FABRIC_STACK_MIN_SIZE 512

#define MEM_LITE_FABRIC_FIRMWARE_BASE (MEM_ERISC_RESERVED1 + MEM_ERISC_RESERVED1_SIZE)
#define MEM_LITE_FABRIC_FIRMWARE_SIZE (8 * 1024)

#define MEM_LITE_FABRIC_CONFIG_BASE (MEM_LITE_FABRIC_FIRMWARE_BASE + MEM_LITE_FABRIC_FIRMWARE_SIZE)
#define MEM_LITE_FABRIC_CONFIG_SIZE 73728

#define MEM_LITE_FABRIC_MAP_END (MEM_LITE_FABRIC_CONFIG_BASE + MEM_LITE_FABRIC_CONFIG_SIZE)

#define MEM_LITE_FABRIC_INIT_LOCAL_L1_BASE_SCRATCH MEM_LITE_FABRIC_MAP_END
#define MEM_LITE_FABRIC_BANK_TO_NOC_SCRATCH (MEM_LITE_FABRIC_INIT_LOCAL_L1_BASE_SCRATCH + MEM_ERISC_LOCAL_SIZE)
#define MEM_LITE_FABRIC_BANK_TO_NOC_SIZE (MEM_BANK_TO_NOC_XY_SIZE + MEM_BANK_OFFSET_SIZE)

// Running on ERISC1
#define MEM_LITE_FABRIC_RESET_PC (MEM_LOCAL_BASE | 0x14008)
