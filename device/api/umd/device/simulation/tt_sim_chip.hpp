...
private:
    ...
    void (*pfn_libttsim_configure_eth_socket)(uint32_t tile_id, const char *address, bool is_server) = nullptr;
    bool (*pfn_libttsim_connect_eth_sockets)() = nullptr;
    void (*pfn_libttsim_init)(uint32_t chip_id) = nullptr;
