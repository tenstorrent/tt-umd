...
protected:
    ...
    // This is hack to report proper logical ETH IDs, sicne eth id on ETH core on Blackhole
    // does not take harvesting into consideration. This function will be override just for Blackhole.
