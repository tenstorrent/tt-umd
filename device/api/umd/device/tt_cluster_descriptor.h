...
public:
     ...
     * The map returned maps each chip and its core to a pair representing the remote chip and its core.
     ...
     * The map returned maps each chip and its core to a pair representing the remote chip unique id and its core.
     * All connections are bidirectional (each connection is reported twice).
     *
