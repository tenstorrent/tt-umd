...
protected:
    BlackholeTTDevice(std::shared_ptr<PCIDevice> pci_device, const std::string &soc_desc_path = "");
    BlackholeTTDevice(std::shared_ptr<JtagDevice> jtag_device, uint8_t jlink_id, const std::string &soc_desc_path = "");
