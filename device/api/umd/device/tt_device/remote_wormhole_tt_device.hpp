...
public:
    ...
    void read_from_device_reg(void* mem_ptr, tt_xy_pair core, uint64_t addr, uint32_t size) override;

    void write_to_device_reg(const void* mem_ptr, tt_xy_pair core, uint64_t addr, uint32_t size) override;
