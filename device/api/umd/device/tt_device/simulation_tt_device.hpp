...
public:
    ...
    // Simulation has no PCIe protocol behind it (device_protocol_ is null) and no UC/WC distinction to
    // make, so register access is the same transfer as memory access.
