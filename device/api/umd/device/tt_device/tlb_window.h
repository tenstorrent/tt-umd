...
public:
    ...
    void write_block(uint64_t offset, const void* data, size_t size, CacheMode mode = CacheMode::WC);

    void read_block(uint64_t offset, void* data, size_t size, CacheMode mode = CacheMode::WC);
