...
public:
     ...
     * @param noc_id NOC to issue the register read over
     */
    uint32_t get_risc_reset_state(CoreCoord core, NocId noc_id);
     ...
     * @param noc_id NOC to issue the register write over
     */
    void set_risc_reset_state(CoreCoord core, const uint32_t risc_flags, NocId noc_id);
     ...
     * @param noc_id NOC to issue the reset register accesses over
     */
    virtual void assert_risc_reset(CoreCoord core, const RiscType selected_riscs, NocId noc_id);
     ...
     * @param noc_id NOC to issue the reset register accesses over
     */
    virtual void deassert_risc_reset(CoreCoord core, const RiscType selected_riscs, bool staggered_start, NocId noc_id);
