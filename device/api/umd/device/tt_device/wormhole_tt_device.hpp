...
public:
    ...
    WormholeTTDevice(std::shared_ptr<PCIDevice> pci_device, bool allow_spi = false);
...
protected:
     ...
     */
    WormholeTTDevice(bool allow_spi = false);
...
private:
    friend std::unique_ptr<TTDevice> TTDevice::create(int device_number, IODeviceType device_type, bool allow_spi);
