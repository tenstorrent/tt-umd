...
public:
    ...
    // Programs one outbound iATU region, through a firmware command on Wormhole. Not part of
    ...
    // wiring into SiliconSysmemManager; delete it instead if that support is dropped.
