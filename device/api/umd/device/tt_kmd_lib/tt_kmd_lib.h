...
enum tt_dma_map_flags {
     ...
     *
     * If your application requires device-side software to access the pinned
     * host buffer via a hard-coded address, your host-side software ought to
     * check that the resulting NOC address matches what it expects.
     */
    TT_DMA_FLAG_NOC = 1 << 0,
