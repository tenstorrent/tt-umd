...
void MockChip::safe_write_to_device(CoreCoord core, const void* src, uint64_t l1_dest, uint32_t size) {}

void MockChip::safe_read_from_device(CoreCoord core, void* dest, uint64_t l1_src, uint32_t size) {}

void MockChip::safe_write_to_device_reg(CoreCoord core, const void* src, uint64_t reg_dest, uint32_t size) {}

void MockChip::safe_read_from_device_reg(CoreCoord core, void* dest, uint64_t reg_src, uint32_t size) {}
