...
std::unique_ptr<SysmemBuffer> SysmemManager::allocate_sysmem_buffer(
    uint32_t sysmem_buffer_size, const bool map_to_noc) {
    void *mapping =
...
std::unique_ptr<SysmemBuffer> SysmemManager::map_sysmem_buffer(
    void *buffer, uint32_t sysmem_buffer_size, const bool map_to_noc) {
