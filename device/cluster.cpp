...
void Cluster::configure_active_ethernet_cores_for_mmio_device(
    ...
    std::unordered_set<CoreCoord> active_eth_corecoords;
    for (const auto& core : active_eth_cores_per_chip) {
        active_eth_corecoords.insert(get_soc_descriptor(mmio_chip).get_coord_at(core, CoordSystem::VIRTUAL));
    }
    configure_active_ethernet_cores_for_mmio_device(active_eth_corecoords, mmio_chip);
}
