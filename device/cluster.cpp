...
void Cluster::construct_cluster(const uint32_t& num_host_mem_ch_per_mmio_device, const ChipType& chip_type) {
    ZoneScopedNC("Cluster::construct_cluster", tracy::Color::DarkGreen);
...
void Cluster::deassert_resets_and_set_power_state() {
    ZoneScopedNC("Cluster::deassert_resets_and_set_power_state", tracy::Color::DarkGreen);
...
void Cluster::start_device(const DeviceParams& device_params) {
    ZoneScopedNC("Cluster::start_device", tracy::Color::DarkGreen);
...
void Cluster::close_device() {
    ZoneScopedNC("Cluster::close_device", tracy::Color::DarkRed);
...
std::unique_ptr<ClusterDescriptor> Cluster::create_cluster_descriptor(
    ...
    ZoneScopedNC("Cluster::create_cluster_descriptor", tracy::Color::DarkGreen);
