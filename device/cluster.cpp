...
void Cluster::write_device_memory(
    ...
    // TODO: abolish fallback_tlb, use proper interfaces to discern between DMA/non-DMA, register vs memory access.
    std::string fallback_tlb_ = fallback_tlb;

    bool size_ok_for_dma = size_in_bytes % 4 == 0;
