...
TopologyDiscoveryBlackhole::TopologyDiscoveryBlackhole(
    std::unordered_set<chip_id_t> pci_target_devices, const std::string& sdesc_path, bool break_ports, bool disable_wait_on_eth_core_training) :
    TopologyDiscovery(pci_target_devices, sdesc_path, IODeviceType::PCIe, break_ports, disable_wait_on_eth_core_training) {}
