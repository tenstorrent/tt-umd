 ...
 * Silicon and software (test/sim implementations).
...
class tt_device
{
    ...
    */
    ...
    /** 
     * @brief Start the Silicon Device
    ...
    */
    ...
    /**
    * @brief Write uint32_t vector to specified device, core and address
    ...
    */
    ...
    /**
    * @brief Unroll/replicate a uint32_t vector and write it to specified device, core and address
    * \param vec Vector to write
    * \param unroll_count Number of times vector should be unrolled
    * \param core chip-x-y struct specifying device and core
    * \param addr Address to write to
    ...
    */
    ...
    /**
    * @brief Read a uint32_t vector from a specified device, core and address to host memory
