...
TTDevice::TTDevice(
    ...
    LockManager::initialize_mutex(MutexType::TT_DEVICE_IO, this, false);
...
void TTDevice::read_from_device(void *mem_ptr, tt_xy_pair core, uint64_t addr, uint32_t size) {
    auto lock = LockManager::get_mutex(MutexType::TT_DEVICE_IO, this);
...
TTDevice::~TTDevice() { LockManager::clear_mutex(MutexType::TT_DEVICE_IO, this); }
