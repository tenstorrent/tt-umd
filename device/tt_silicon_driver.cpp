...
tt_SiliconDevice::tt_SiliconDevice(const std::string &sdesc_path, const std::string &ndesc_path, const std::set<chip_id_t> &target_devices, 
    ...
    auto architecture_implementation = tt::umd::TTDevice::create(static_cast<tt::umd::architecture>(arch_name));
...
inline bool tensix_or_eth_in_broadcast(const std::set<uint32_t>& cols_to_exclude, const tt::umd::TTDevice* architecture_implementation) {
...
inline bool valid_tensix_broadcast_grid(const std::set<uint32_t>& rows_to_exclude, const std::set<uint32_t>& cols_to_exclude, const tt::umd::TTDevice* architecture_implementation) {
