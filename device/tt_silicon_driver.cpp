...
volatile bool msi_interrupt_received = false;   // TODO(jms): ?!?
...
PCIdevice ttkmd_open(uint32_t device_index)
{
    ...
    std::cout << device.BAR_addr << std::endl;
    std::terminate();
...
// TODO(jms): appears to be unused by both buda and metal.
