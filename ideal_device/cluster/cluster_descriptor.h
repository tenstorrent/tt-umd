...
class ClusterDescriptor {
   public:
    ...
    static ClusterDescriptor *GetClusterDescriptor(bool run_ethernet_discovery = true); // former not create_for_grayskull_cluster
    ...
    std::unordered_map<chip_id_t, SocDescriptor> soc_descriptors;
