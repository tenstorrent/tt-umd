...
DEVICE_SRCS = \
  new_device/chip.cpp \
  new_device/cluster_descriptor.cpp \
  new_device/cluster.cpp \
  new_device/local_chip.cpp \
  new_device/pci_device.cpp \
  new_device/remote_chip.cpp \
  new_device/soc_descriptor.cpp \
  new_device/tt_device.cpp \
  new_device/wormhole_tt_device.cpp \
...
$(DEVICE_OBJDIR)/new_device/%.o: $(UMD_HOME)/new_device/%.cpp
	@mkdir -p $(@D)
