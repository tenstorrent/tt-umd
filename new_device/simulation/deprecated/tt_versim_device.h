...
class tt_VersimDevice: public tt_device
{
    ...
    virtual void rolled_write_to_device(std::vector<uint32_t> &vec, uint32_t unroll_count, cxy_pair core, uint64_t addr, const std::string& tlb_to_use);
    ...
    virtual void rolled_write_to_device(uint32_t* mem_ptr, uint32_t size_in_bytes, uint32_t unroll_count, cxy_pair core, uint64_t addr, const std::string& fallback_tlb);
    ...
    virtual void read_from_device(void *mem_ptr, cxy_pair core, uint64_t addr, uint32_t size, const std::string& tlb_to_use); 
