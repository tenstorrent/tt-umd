...
// independent evidence that the exported window really reaches device DRAM - it is not the
// self-consistent "write it and read it back through the same window" check that dmabuf_p2p.cpp
// (and the tt-kmd demo it mirrors) performs.
//
...
/* ===== GID selection (same approach as dmabuf_p2p.cpp) ===== */
