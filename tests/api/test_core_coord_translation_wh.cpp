...
//         CoordSystem::TRANSLATED); EXPECT_EQ(
//             eth_translated.x,
...
//             coordinate_manager->translate_coord_to(pcie_logical, CoordSystem::PHYSICAL); const CoreCoord
//             pcie_translated =
...
//     EXPECT_THROW(CoordinateManager::create_coordinate_manager(tt::ARCH::WORMHOLE_B0, true, 0, 1),
//     std::runtime_error);
// }
...
//             CoordinateManager::shuffle_tensix_harvesting_mask(tt::ARCH::WORMHOLE_B0,
//             harvesting_mask_physical_layout);
