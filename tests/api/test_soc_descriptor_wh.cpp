...
TEST(SocDescriptor, SocDescriptorWHLogicalTranslatedTopLeft) {
    ...
    for (std::size_t harvesting_mask = 0; harvesting_mask < (1 << max_num_harvested_y) - 1; harvesting_mask++) {
        ...
        tt_translated_coords translated_from_logical = soc_desc.logical_to_translated_coords(logical_coords);
        tt_translated_coords translated_from_physical = soc_desc.physical_to_translated_coords(physical_coords);
        tt_translated_coords translated_from_virtual = soc_desc.virtual_to_translated_coords(virtual_coords);
