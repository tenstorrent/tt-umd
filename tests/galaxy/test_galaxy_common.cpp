...
void move_data(
    ...
    test_utils::read_data_from_device(
        ...
        readback_vec,
        sender_core.chip,
        device.get_soc_descriptor(sender_core.chip).get_coord_at(sender_core.core, CoordSystem::TRANSLATED),
        sender_core.addr,
        size);
    device.write_to_device(
        ...
        receiver_core.chip,
        device.get_soc_descriptor(receiver_core.chip).get_coord_at(receiver_core.core, CoordSystem::TRANSLATED),
        receiver_core.addr);
