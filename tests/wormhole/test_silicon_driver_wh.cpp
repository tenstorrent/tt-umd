...
TEST(SiliconDriverWH, StaticTLB_RW) {
    ...
    tt_SocDescriptor sdesc = *load_soc_descriptor_from_yaml("./device/wormhole_b0_8x10.yaml");
    ...
    tt_SiliconDevice device = tt_SiliconDevice(sdesc_per_chip, GetClusterDescYAML().string(), target_devices, num_host_mem_ch_per_mmio_device, dynamic_tlb_config);
