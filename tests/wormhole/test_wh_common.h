...
class WormholeTestFixture : public ::testing::Test {
 protected:
  ...
  void SetUp() override {
    ...
    device = std::make_unique<tt_SiliconDevice>(tt::ARCH::WORMHOLE_B0, test_utils::GetClusterDescYAML(), target_devices, num_host_mem_ch_per_mmio_device, false, true, true);
