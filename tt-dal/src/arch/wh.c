...
//==============================================================================
// WORMHOLE ARCHITECTURE-SPECIFIC IMPLEMENTATION
//==============================================================================

/**
 * Send ARC message to Wormhole device.
 *
...
tt_result_t tt_wh_arc_msg(
    ...
    // TODO: Implement Wormhole ARC messaging
    ...
    (void)wait;
    (void)timeout;
    return -(tt_errno = TT_ENOTSUP);
}

/**
 * Get telemetry from Wormhole device.
 *
...
tt_result_t tt_wh_get_telemetry(
    ...
    // TODO: Implement Wormhole telemetry reading
