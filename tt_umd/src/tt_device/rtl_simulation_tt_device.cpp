...
#include "tt_umd/pcie/rtl_sim_tlb_handle.hpp"
#include "tt_umd/pcie/rtl_sim_tlb_window.hpp"
...
std::unique_ptr<RtlSimulationTTDevice> RtlSimulationTTDevice::create(
    ...
    auto soc_desc_path = get_simulation_soc_descriptor_path(simulator_directory);
