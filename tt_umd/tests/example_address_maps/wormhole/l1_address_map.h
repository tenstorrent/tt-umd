...
struct address_map {
    ...
    static constexpr uint32_t BRISC_FIRMWARE_SIZE =
    ...
    static constexpr uint32_t FW_L1_BLOCK_SIZE = FIRMWARE_SIZE + NCRISC_FIRMWARE_SIZE + TRISC0_SIZE + TRISC1_SIZE +
    ...
    static constexpr uint32_t NCRISC_LOCAL_MEM_BASE =
        NCRISC_FIRMWARE_BASE + NCRISC_FIRMWARE_SIZE - NCRISC_LOCAL_MEM_SIZE;  // Copy of the local memory
    static constexpr uint32_t NCRISC_L1_SCRATCH_BASE =
    ...
    static constexpr uint32_t NCRISC_L1_CONTEXT_BASE =
    ...
    static constexpr uint32_t NCRISC_PERF_QUEUE_HEADER_ADDR =
        NCRISC_FIRMWARE_BASE + NCRISC_L1_SCRATCH_SIZE;  // L1 Performance Buffer used by NCRISC
    static constexpr uint32_t NCRISC_L1_PERF_BUF_BASE =
    ...
    static constexpr uint32_t NCRISC_PERF_BUF_SIZE_LEVEL_1 =
        4 * 1024 - NCRISC_PERF_QUEUE_HEADER_SIZE;  // NCRISC performance buffer
    static constexpr uint32_t NCRISC_L1_EPOCH_Q_BASE =
    ...
    static constexpr uint32_t TRISC0_LOCAL_MEM_BASE =
    ...
    static constexpr uint32_t TRISC1_LOCAL_MEM_BASE =
    ...
    static constexpr uint32_t TRISC2_LOCAL_MEM_BASE =
    ...
    static constexpr uint32_t DATA_BUFFER_SPACE_BASE =
    ...
    static constexpr uint32_t RISC_LOCAL_MEM_BASE =
    ...
    static constexpr uint32_t UNPACK_PACK_PERF_BUF_SIZE_LEVEL_1 =
    ...
    static constexpr uint32_t BRISC_PERF_BUF_BASE_ADDR =
