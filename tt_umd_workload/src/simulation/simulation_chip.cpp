...
#include "tt_umd_workload/simulation/rtl_simulation_chip.hpp"
#include "tt_umd_workload/simulation/tt_sim_chip.hpp"
...
std::string SimulationChip::get_soc_descriptor_path_from_simulator_path(const std::filesystem::path& simulator_path) {
    return get_simulation_soc_descriptor_path(simulator_path);
}
